...
const Footer = ({ company }) => {
	const elonTwitter = company.hasOwnProperty('links') ? company.links.elon_twitter : '#';
	const twitter = company.hasOwnProperty('links') ? company.links.twitter : '#';
	const flickr = company.hasOwnProperty('links') ? company.links.flickr : '#';
	const website = company.hasOwnProperty('links') ? company.links.website : '#';
	...
	return (
		<footer className="footer">
			...
			<p className="footer-text">
				For additional questions, contact <a className="footer-link" href="mailto:rideshare@spacex.com">rideshare@spacex.com</a>
			</p>
		</footer>
	);
}
